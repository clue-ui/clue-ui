...
export function registerComponent (Vue, name, def) {
  Vue._clue_ui_components_ = Vue._clue_ui_components_ || {}
  const loaded = Vue._clue_ui_components_[name]
  if (!loaded && def && name) {
    Vue._clue_ui_components_[name] = true
...
export function registerDirective (Vue, name, def) {
  Vue._clue_ui_directives_ = Vue._clue_ui_directives_ || {}
  const loaded = Vue._clue_ui_directives_[name]
  if (!loaded && def && name) {
    Vue._clue_ui_directives_[name] = true
